package com.example.zwd.springbootswagger2;
...
public class SpringBootSwagger2MarkupApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringBootSwagger2MarkupApplication.class, args);
	}
	@Bean
